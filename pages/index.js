...
export default function Home() {
  ...
  return (
    <Layout>
      ...
      <div className="fixed bottom-0 left-0 right-0 pl-3 py-3 flex items-end font-mono w-[65%]">
      ...
      <div className="fixed top-0 left-0 right-0 p-3 font-mono w-full flex flex-wrap">
